...
export default function wordSign({params}:{params : {chapters: number}}) {
    ...
    const is_deaf = (currentPath[3] === 'sign_wrong');
    const searchParams = useSearchParams();
    const total = parseInt(searchParams.get('total'));
    const wordnum = parseInt(searchParams.get("wordnum"));
    ...
    return (
      <>
        <LectureNum situation={site[place]} type={type} chapter={params.chapters} is_deaf={is_deaf} word_num={} />
