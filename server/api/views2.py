...
#     SMS_SECRET_KEY = settings.SMS_SECRET_KEY
#     SMS_SENDNO = settings.SMS_SENDNO
#     post_url = f'https://api-sms.cloud.toast.com/sms/v3.0/appKeys/{SMS_APP_KEY}/sender/sms'
#
#     headers = {
#         'X-Seret-Key' : SMS_SECRET_KEY,
